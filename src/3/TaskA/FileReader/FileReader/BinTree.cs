...
namespace FileReader
{
    class BinTree<T> where T : IComparable
    {
        ...
        private bool subTree(Node<T> node1, Node<T> node2)
        {
            ...
            {
                return subTree(node1.Right, node2) || subTree(node1.Left, node2);
            }
        }
